...
public class LoggingImageViewer {
	static String packageName = "com.yan96in.corejava";
	...
	public static void main(String[] args) {
		if (System.getProperty("java.util.logging.config.class") == null
			...
			try {
				...
				Logger.getLogger(packageName).log(Level.SEVERE, "Can't create log file handler", e);
			}
		}
...
class ImageViewerFrame extends JFrame {
	...
	private static Logger logger = Logger.getLogger("com.yan96in.corejava");
